...
export const MOCK_COURSES: Course[] = [
  {
    ...
    prerequisites: [
      { id: 'II2011', name: 'Aljabar Linear', prereqs: [{ id: 'MA1101', name: 'Matematika I' }] },
      { id: 'II2012', name: 'Probabilitas & Statistik', prereqs: [{ id: 'MA1101', name: 'Matematika I' }] },
    ],
  ...
  },
  {
    ...
    prerequisites: [
      { id: 'II3011', name: 'Database Systems', prereqs: [{ id: 'IF1210', name: 'Dasar Pemrograman' }] },
    ],
  ...
  },
  {
    ...
    prerequisites: [
      { id: 'IF1210', name: 'Dasar Pemrograman', prereqs: [] },
    ],
  ...
  },
  {
    ...
    prerequisites: [
      { id: 'MA1101', name: 'Matematika I', prereqs: [] },
    ],
    workload: { hours: 150, lectureCredits: 3, labCredits: 0 },
  },
];
...
export const SCHEDULE: ScheduleItem[] = [
  { id: 1, course: 'Machine Learning', code: 'II4042', day: 'Selasa', start: 10, duration: 2, color: 'bg-teal/20 text-teal-dark border-teal/50', room: 'Lab Komputasi 1' },
  { id: 2, course: 'Data Visualization', code: 'II4045', day: 'Selasa', start: 10, duration: 3, color: 'bg-warning/20 text-warning-dark border-warning/50', conflict: true, room: 'Lab Komputasi 2' },
  { id: 3, course: 'Kewarganegaraan', code: 'KU2001', day: 'Rabu', start: 7, duration: 2, color: 'bg-navy/10 text-navy border-navy/30', room: 'R. 201' },
  { id: 4, course: 'Deep Learning', code: 'II4050', day: 'Kamis', start: 13, duration: 3, color: 'bg-gold/20 text-gold-dark border-gold/50', room: 'Lab Komputasi 3' },
];
